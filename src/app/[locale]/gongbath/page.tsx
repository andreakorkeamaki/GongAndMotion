        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="bg-gradient-to-br from-primary-light/20 to-accent-purple/10 rounded-xl p-6 border border-accent-purple/10">
              <h3 className="font-semibold text-primary-dark mb-2">• {dict.gongbath.main_benefits.deep_relaxation}</h3>
            </div>
            <div className="bg-gradient-to-br from-accent-purple/10 to-primary-light/20 rounded-xl p-6 border border-accent-purple/10">
              <h3 className="font-semibold text-primary-dark mb-2">• {dict.gongbath.main_benefits.anxiety_relief}</h3>
            </div>
            <div className="bg-gradient-to-br from-primary-light/20 to-accent-purple/10 rounded-xl p-6 border border-accent-purple/10">
              <h3 className="font-semibold text-primary-dark mb-2">• {dict.gongbath.main_benefits.healing_stimulation}</h3>
            </div>
            <div className="bg-gradient-to-br from-accent-purple/10 to-primary-light/20 rounded-xl p-6 border border-accent-purple/10">
