...
export const metadata: Metadata = {
  title: "Contact – Gong and Motion",
  description:
    "Write or call us for information and bookings. We are here for you!",
};
        ...
        <div className="max-w-xl mx-auto rounded-2xl shadow-lg bg-white/90 p-8 border border-accent-purple/10">
          ...
          <form className="flex flex-col gap-3">
            <div className="text-left">
              ...
              <input id="name" name="name" className="w-full border border-accent-purple rounded-full px-4 py-2 focus:outline-none focus:ring-2 focus:ring-accent-purple" type="text" placeholder="Your Name" required />
            </div>
            <div className="text-left">
              <label htmlFor="email" className="sr-only">Your Email</label>
              <input id="email" name="email" className="w-full border border-accent-purple rounded-full px-4 py-2 focus:outline-none focus:ring-2 focus:ring-accent-purple" type="email" placeholder="Your Email" required />
            </div>
            <div className="text-left">
              <label htmlFor="message" className="sr-only">Your Message</label>
              <textarea id="message" name="message" className="w-full border border-accent-purple rounded-2xl px-4 py-2 focus:outline-none focus:ring-2 focus:ring-accent-purple" placeholder="Your Message" required />
            </div>
